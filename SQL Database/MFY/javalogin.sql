...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2020 at 12:24 PM
...
--
-- Dumping data for table `discrete`
--

INSERT INTO `discrete` (`id`, `Question`, `option1`, `option2`, `option3`, `option4`, `Answer`) VALUES
(1, 'sample Question', '1', '2', '3', '4', 'C');
...
(3, 'FA19BSSE0014', 'AAC@600'),
(5, 'FA19BSSE0008', 'empire');
...
INSERT INTO `resultofquiz` (`id`, `QuizName`, `TotalQuestion`, `NoOfQuestionCorrect`, `Percentage`, `Time`, `UserId`) VALUES
(2, 'Applied Physics-SP20', '5', '4', '20.5', '2020-06-10', 'FA19BSSE0014'),
(10, 'OC', '50', '38', '80.2', ' 10/06/2020 22:30:11', 'FA19BSSE0014'),
(14, 'oop(object-oriented programming)', '5', '2', '40.0', '19/06/2020 12:26:33', 'FA19BSSE0014');
...
INSERT INTO `subjectlist` (`id`, `Field`, `Pincode`, `QuizTime`, `QuizNoofAttemp`, `TotalQuestion`) VALUES
(2, 'oop(object-oriented programming)', '123', 10, 5, 10),
(4, 'Applied Physics-SP20', '159753', 10, 1, 0),
(8, 'OC', 'BF8E3O', 45, 50, 85),
(9, 'Discrete', '357951', 45, 50, 0),
(10, '', '', 0, 0, 0);
...
--
-- Indexes for table `discrete`
--
ALTER TABLE `discrete`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `discrete`
--
ALTER TABLE `discrete`
